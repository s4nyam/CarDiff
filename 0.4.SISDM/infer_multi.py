...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--checkpoint', type=Path, default=Path('./sisdm_runs_multi/checkpoints/checkpoint_step_005000.pt'),
                        help='Path to a trained SISDM checkpoint (.pt).')
    parser.add_argument('--masks-dir', type=Path, default=Path('./test_masks_multi'),
                        help='Directory of input segmentation masks.')
    parser.add_argument('--output-dir', type=Path, default=Path('./infer_outputs_multi'),
    ...
    parser.add_argument('--sample-steps', type=str, default=None,
