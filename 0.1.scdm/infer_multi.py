...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--checkpoint', type=Path, default=Path('./scdm_runs_multi/checkpoints/scdm_step_0150000.pt'),
                        help='Path to a trained SCDM checkpoint (.pt).')
    parser.add_argument('--masks-dir', type=Path, default=Path('/mnt/d/playground/0.1.SCDM/test_masks_multi'),
                        help='Directory of input segmentation masks.')
    parser.add_argument('--output-dir', type=Path, default=Path('/mnt/d/playground/0.1.SCDM/infer_masks_multi'),
