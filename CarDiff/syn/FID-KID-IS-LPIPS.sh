...
srun singularity exec \
    ...
    py_cotainr.sif \
    python clpips_classwise.py \
    --base_path /scratch/project_465002351/cardiff/epoch_wise_test_data_classwise/ \
    --results_dir /scratch/project_465002351/cardiff/results/test-classwise 