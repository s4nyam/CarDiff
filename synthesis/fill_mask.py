...
def generate_images_from_masks(model_dir, masks_dir, output_dir="generated_images", 
                             batch_size=8, num_inference_steps=50, image_size=384,
...
def main():
    ...
    parser.add_argument("--model_dir", type=str, default="ddpm-dc-384-segguided/checkpoint_epoch_220",
                       help="Path to model checkpoint directory")
    
    parser.add_argument("--masks_dir", type=str, default="train_data/trainannot",
                       help="Path to directory containing mask images (e.g., /path/to/MASK_FOLDER/all/test)")
    
    parser.add_argument("--output_dir", type=str, default="epoch_wise_train_data/syntrain-ep1000-ddpm",
