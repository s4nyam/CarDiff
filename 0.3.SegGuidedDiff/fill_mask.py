    ...
    with torch.no_grad():
        for batch_idx, seg_batch in enumerate(tqdm(dataloader, desc="Generating images")):
            ...
            for i, (img, filename) in enumerate(zip(images, seg_batch["image_filenames"])):
                ...
                base_name = os.path.splitext(filename)[0]
                output_filename = f"generated_{base_name}.png"
...
def main():
    ...
    parser.add_argument("--model_dir", type=str, default="ddpm-dc-384/checkpoint_epoch_300",
                       help="Path to model checkpoint directory (e.g., /path/to/ddpm-dc-384-segguided/checkpoint_epoch_600)")
    
    parser.add_argument("--masks_dir", type=str, default="masks_for_paper/",
                       help="Path to directory containing mask images (e.g., /path/to/MASK_FOLDER/all/test)")
    
    parser.add_argument("--output_dir", type=str, default="images_for_paper/",
    ...
    parser.add_argument("--mosaic_count", type=int, default=6,
